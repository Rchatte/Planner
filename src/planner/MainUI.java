...
public class MainUI {
	...
	public void monthSetUp(Calendar start) {
		preset(start);
		upcomingEvents(Calendar.getInstance(TimeZone.getDefault(), Locale.US));
		days = new GridPane();
		bp.setCenter(days);
		days.setVgap(25);
		days.setHgap(25);
	...
	public void checkDay(Calendar day) {
		...
		infoSection.calMenu.setOnAction(e ->{
	...
	public void upcomingEvents(Calendar day) {
		//Upcoming events


		Calendar c = (Calendar)day.clone();
		bp.setRight(infoSection.getUpcoming(c));
